...
hl.animation({ leaf = "windowsIn",     enabled = true, speed = 1.5,  bezier = "easeOutQuint",         })
hl.animation({ leaf = "windowsOut",    enabled = true, speed = 1.5, bezier = "easeOutQuint",       })
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("noctalia msg panel-open launcher"))
